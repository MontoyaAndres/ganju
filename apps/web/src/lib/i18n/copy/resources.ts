...
const en = {
  ...
  syncHint:
    'Only new or changed content is re-indexed, and what was removed at the source is removed here too.',
  syncNow: 'Sync now',
  syncIntervalLabel: 'Sync automatically',
  syncAutoOnHint: 'Checks for changes {every}.',
  syncAutoOffHint: 'Off. This source only syncs when you press Sync now.',
  syncFrequencyLabel: 'How often',
  syncSettings: 'Sync settings',
  syncIntervalDaily: 'Daily',
  syncIntervalWeekly: 'Weekly',
  syncLockedHint:
    'Automatic sync is a Pro feature. You can still sync this source by hand.',
  syncUpgrade: 'Upgrade to Pro',
  ...
  toastSyncFailed: 'Failed to start the sync',
  toastSyncIntervalUpdated: 'Sync schedule updated',
  toastSyncIntervalFailed: 'Failed to update the sync schedule',
...
export const RESOURCES: Catalog<ResourcesCopy> = {
  ...
  es: {
    ...
    syncNever: 'Todavía no se ha sincronizado',
    syncHint:
      'Solo se vuelve a indexar lo nuevo o lo que cambió, y lo que se eliminó en el origen también se elimina aquí.',
    syncNow: 'Sincronizar ahora',
    syncIntervalLabel: 'Sincronizar automáticamente',
    syncAutoOnHint: 'Busca cambios {every}.',
    syncAutoOffHint:
      'Desactivada. Esta fuente solo se sincroniza cuando presionas Sincronizar ahora.',
    syncFrequencyLabel: 'Frecuencia',
    syncSettings: 'Configuración de sincronización',
    syncIntervalDaily: 'Cada día',
    syncIntervalWeekly: 'Cada semana',
    syncLockedHint:
      'La sincronización automática es una función de Pro. Puedes sincronizar esta fuente a mano.',
    syncUpgrade: 'Cambiar a Pro',
    ...
    toastSyncFailed: 'No pudimos iniciar la sincronización',
    toastSyncIntervalUpdated: 'Frecuencia de sincronización actualizada',
    toastSyncIntervalFailed:
      'No pudimos actualizar la frecuencia de sincronización',
