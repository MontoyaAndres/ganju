...
const en = {
  ...
  modelPick: 'Model',
  modelCustom: 'Custom (OpenAI-compatible)',
  modelCustomHint:
    'Any service that speaks the OpenAI chat-completions protocol — a gateway, an aggregator, or your own server. Paste its model ID and base URL below.',
  modelId: 'Model ID',
  modelIdPlaceholder: 'e.g. anthropic/claude-opus-5',
  modelApiKey: 'API key',
  modelApiKeyKeep: 'API key (leave blank to keep)',
  modelBaseUrl: 'Base URL (optional)',
  modelBaseUrlRequired: 'Base URL',
  modelBaseUrlPlaceholder: 'https://openrouter.ai/api/v1',
  ...
  modelBaseUrlRequiredError: 'A base URL is required for a custom model',
  modelBaseUrlInvalid: 'Enter a public https:// address',
...
export const SETTINGS: Catalog<SettingsCopy> = {
  ...
  es: {
    ...
    modelPick: 'Modelo',
    modelCustom: 'Personalizado (compatible con OpenAI)',
    modelCustomHint:
      'Cualquier servicio que hable el protocolo de chat-completions de OpenAI — una pasarela, un agregador o tu propio servidor. Pega abajo su ID de modelo y su URL base.',
    modelId: 'ID del modelo',
    modelIdPlaceholder: 'ej. anthropic/claude-opus-5',
    modelApiKey: 'Clave de API',
    modelApiKeyKeep: 'Clave de API (déjala vacía para conservarla)',
    modelBaseUrl: 'URL base (opcional)',
    modelBaseUrlRequired: 'URL base',
    modelBaseUrlPlaceholder: 'https://openrouter.ai/api/v1',
    ...
    modelBaseUrlRequiredError:
      'La URL base es obligatoria para un modelo personalizado',
    modelBaseUrlInvalid: 'Escribe una dirección https:// pública',
