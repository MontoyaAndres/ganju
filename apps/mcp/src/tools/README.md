...
| `search-resources`                                                                                                                            | resources       | —                   | Hybrid search (vector + full text, rank-fused) via `db.searchResourceChunks`. Results carry citation fields when known: `source`, `page`, `section`, `updatedAt`.                                                                                                                                                                                                                |
